    ...
    <main class="app-main">
        ...
        <div class="page-header">
            ...
            <div class="page-acciones">
                ...
                <div class="seg-vista" role="tablist" aria-label="Formato de hora">
                    <button type="button" data-formato-hora="24" id="btnFormato24h" class="activo">24h</button>
                    <button type="button" data-formato-hora="12" id="btnFormato12h">12h</button>
                </div>
